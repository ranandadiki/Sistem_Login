<div class="container-fluid">
    ...
    <form action="hasil" method="post">
        ...
        if ($_POST != NULL) {
            ...
            echo "<h2 align='center'><font color='black'>Tabel Optimalisasi dengan Metode VAM dan MODI</font></h2>";
            echo "<table  class='table' align='center'>";
            echo " <tr><td><font color='black'>Supply / Demand</font></td>";
            ...
            for ($i = 1; $i <= $s_supply; $i++) {
                ...
                if ($i == $s_supply && $dummy_supply == 1) {
                    ...
                    echo "<td>kandang $i</td>";
                }
                for ($j = 1; $j <= $s_demand; $j++) {

                    if ($arr[$i][$j] > 0) {
                        echo "<td><table><tr ><td  rowspan='1' width='50'><font color='red'>" . $arr[$i][$j] . '</font></td><td style="border-left:1px solid;border-bottom:1px solid;" ><font color="black">' . $cost[$i][$j] . "</font></td></tr><tr><td>&nbsp;</td></tr></table></td>";
                    } else {
                        echo "<td><table ><tr ><td  rowspan='1' width='50'>0</td><td style='border-left:1px solid;border-bottom:1px solid;width:auto;'><font color='black'>" . $cost[$i][$j] . "</font></td></tr><tr><td>&nbsp;</td></tr></table></td>";
                    }
                    if ($j == $s_demand) {
                        echo "<td><font color='black'> <strong>" . $x_supply[$i] . "</strong></font></td>";
                    }
                }
            ...
            for ($l = 1; $l <= $s_demand; $l++) {
                echo "<td><font color='black'><strong>" . $x_demand[$l] . "</strong></font></td>";
            }
            ...
            echo "</table";
            echo "<table>";
            echo "<legend align='center'><font color='black'>Hasil Optimalisasi</font></legend>";
            ...
            for ($i = 1; $i <= $s_supply; $i++) {
                ...
                for ($j = 1; $j <= $s_demand; $j++) {
                    ...
                    if ($arr[$i][$j] > 0 && $cost[$i][$j] > 0) {
                        echo "<font color='black'>Kandang $i x Daerah $j =</font>&nbsp;" . $cost[$i][$j] . "&nbsp;x&nbsp;<font color='black'>" . $arr[$i][$j] . "</font>&nbsp;=&nbsp;" . $cost[$i][$j] * $arr[$i][$j] . "&nbsp;";
                        echo "<br />";
                    } else {
                        continue;
                    }
            ...
            echo "Total Cost :&nbsp; <font color='black'>Rp." . number_format($total);
            echo "</font><br /><a href='index.php'>Ulangi</a>";
            echo "</div>";
            echo "</table>";
        } else {
        ...
        ?>
        <button class="btn btn-info btn-md" type="submit" style="float: right;">Buat Laporan</button>
    </form>
</div>